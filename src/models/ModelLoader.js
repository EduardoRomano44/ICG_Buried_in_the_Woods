...
function loadSlimes(list_positions=0){
  for (let i = 0; i < list_positions.length; i++){
    loadSlime(list_positions[i][0], list_positions[i][1], list_positions[i][2]);
  }
}

function loadLamps(list_positions=[]){
  for (let i = 0; i < list_positions.length; i++){
    loadLamp(list_positions[i][0], list_positions[i][1], list_positions[i][2]);
  }
}

function loadTrees(list_positions=[]){
  for (let i = 0; i < list_positions.length; i++){
    loadTree(list_positions[i][0], list_positions[i][1], list_positions[i][2]);
  }
}
